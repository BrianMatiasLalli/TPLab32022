...
public class Main {
    public static void main(String[] args){
        ...
        catalogo.agregar(almacenamiento1);
        catalogo.agregar(almacenamiento2);
        catalogo.agregar(almacenamiento3);
        catalogo.agregar(auriculares1);
        catalogo.agregar(auriculares2);
        catalogo.agregar(auriculares3);
        catalogo.agregar(cooler1);
        catalogo.agregar(cooler2);
        catalogo.agregar(coolerCpu);
        
        //System.out.println(catalogo.listarAlmacenamiento());
        ...
        Cliente nuevoCliente2= new Cliente("brian","Lali","40395123","223111111","calle falsa 123","brianlali@gmail.com");
        Cliente nuevoCliente3= new Cliente("alguien","nosecuanto","33342323","223661711","laloma del culo","choto@gmail.com");
        Cliente nuevoCliente4= new Cliente("gonzalo","Benoffi","39395123","223432111","en el centro 123","benoffi@gmail.com");
        Cliente nuevoCliente5= new Cliente("matias","sorongo","40392313","2235213511","mexico 999","alguien@gmail.com");
        Cliente nuevoCliente6= new Cliente("tuvieja","elchoto","11442323","22567567","3 de febrero 111","laputa@gmail.com");
        Cliente nuevoCliente7= new Cliente("james","hetfield","14395123","5409121391283","USA","metallica@gmail.com");
        
        listaClientes.agregarObjetoColeccion(nuevoCliente.getDni(), nuevoCliente);
        listaClientes.agregarObjetoColeccion(nuevoCliente2.getDni(), nuevoCliente2);
        listaClientes.agregarObjetoColeccion(nuevoCliente3.getDni(), nuevoCliente3);
        listaClientes.agregarObjetoColeccion(nuevoCliente4.getDni(), nuevoCliente4);
        listaClientes.agregarObjetoColeccion(nuevoCliente5.getDni(), nuevoCliente5);
        listaClientes.agregarObjetoColeccion(nuevoCliente6.getDni(), nuevoCliente6);
        listaClientes.agregarObjetoColeccion(nuevoCliente7.getDni(), nuevoCliente7);
        //listaClientes.eliminarObjDeLaColeccion(nuevoCliente4.getDni());
        //System.out.println(listaClientes.mostrarElementoDeLaColeccion("30395657"));
